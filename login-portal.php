...
if (isset($_POST['uname']) && isset($_POST['password']) && isset($_POST['g-recaptcha-response'])) {
    ...
    if (empty($uname) || empty($pass)) {
        ...
        // Verify reCAPTCHA
        $secretKey = "6LfAFesqAAAAANf3bTW8ePEzt1dfCtTWhoUHh7rZ";
...
<head>
  ...
  <title>GradeAssist - Grade Assist - Portal</title>
        ...
        <div class="col-lg-6 col-md-8 col-sm-12">
            <div class="card shadow">
                ...
                <div class="card-footer text-muted text-center">
                    <small>Student/Parent Portal Login</small>
                </div>
                        ...
                        <div class="col-sm-9 mt-5 mb-5" style="background-color: #FFFFFF;"> <!-- Adjusted for small devices -->
                            <div class="card mb-3 shadow px-0">
                                <div class="card-body">
                                    ...
                                    <hr>
                                     <form class="user" action="student_login_auth.php" method="post" id="login-form">
                                       ...
                                       <div class="container d-flex justify-content-center align-items-center mt-3">
                                        ...
                                        <div class="col-12 mt-3 d-flex justify-content-center">
                                            <button type="submit" id="signInButton" class="btn btn-sm btn-primary px-3" type="submit"><i class="bi bi-box-arrow-in-right mr-2"></i> Sign in</button>
                                        </div>
                                        <hr>
                                        <div class="col-12">
